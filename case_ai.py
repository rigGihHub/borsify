...
LONG_FIELDS = [
    ...
    "Fundamental Value Range", "Fundamental Value Range status",
    "Fundamental Value Range confidence", "Fundamental Value Range summary",
    "Fundamental Value Range assumptions", "Fundamental Value Range warnings",
    "Fundamental Value Range reason", "Fundamental Value Range ranking effect",
